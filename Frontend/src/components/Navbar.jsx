...
//   const handleLogout = () => {
//     logout(); // 🔥 Asli Logout lagaya hai 🔥
//     closeAll();
//     navigate("/login");
//   };

//   // Profile Photo ke liye ek chota sa component banaya hai
...
//             "Draft a follow-up email for Sophia Chen.",
...
//             "Generate a feature list for Skyview Penthouse.",
...
//             "Draft a VIP newsletter for High Net Worth clients.",
...
//           suggestions: [
//             "Show all pending downpayments for this month.",
//             "Generate a Q3 revenue projection report.",
//             "Draft a payment reminder for Sarah Jenkins.",
...
//             "Draft a confirmation receipt for Unit A-12.",
...
//             "Draft a weekly progress report for the team.",
//             "Show me today's unread notifications."
//           ]
//         };
//     }
//   };
...
//                   <button key={index} className="text-left text-xs font-bold bg-white border border-[#012c7e]/30 text-[#012c7e] px-4 py-2.5 rounded-xl hover:bg-[#dbe1ff]/50 transition-colors">
//                     {suggestion}
//                   </button>
//                 ))}
//               </div>
...
//                 />
//                 <button className="absolute right-3 top-1/2 -translate-y-1/2 text-[#012c7e] hover:text-[#16a34a] transition-colors cursor-pointer">
...
export default function Navbar() {
  ...
  const handleSendMessage = async (suggestedText = null) => {
    ...
    try {
      // 🔥 Yahan seedha localhost ka link daal diya, koi import error nahi aayega! 🔥
